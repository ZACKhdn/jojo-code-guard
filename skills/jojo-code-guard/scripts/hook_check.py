...
try:
    from jojo_guard_core import check_changes, check_conversion_policy, check_diff_size, find_repo
except ImportError:
    from guard_core import check_changes, check_conversion_policy, check_diff_size, find_repo
